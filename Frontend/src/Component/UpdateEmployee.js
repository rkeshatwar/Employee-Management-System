...
const UpdateEmployee = ({getUser}) => {
    ...
    const fetchEmployeeById = async () => {
        try {
            ...
            console.log("Fteched Employee", fetchedEmployee)
            ...
            <div style={{border:'1px solid black', borderRadius:'20px', padding:'20px', margin:'10px', textAlign:'left'}}>
                <div className='d-flex justify-content-around' >
                    <div style={{width:'40%'}}>
                        ...
                        <input type="dateTime" className="form-control" id="dob" name="dob" value={employee.dob} onChange={handleChange}  />
                        </div>

                        <div className="mb-3">
                        <label htmlFor="designation" className="form-label">Designation</label>
                        <input type="text" className="form-control" id="designation" name="designation" value={employee.designation} onChange={handleChange}  />
                        </div>

                        <div className="mb-3">
                        <label htmlFor="reportingManagerId" className="form-label">Reporting Manager ID</label>
                        <input type="text" className="form-control" id="reportingManagerId" name="reportingManagerId" value={employee.reportingManagerId} onChange={handleChange}  />
                        </div>

                        <div className="mb-3">
                        <label htmlFor="gender" className="form-label">Gender</label>
                        <input type="text" className="form-control" id="gender" name="gender" value={employee.gender} onChange={handleChange}  />
                        </div>

                        <div className="mb-3">
                        <label htmlFor="emailId" className="form-label">Email Id</label>
                        <input type="email" className="form-control" id="emailId" name="emailId" value={employee.emailId} onChange={handleChange}  />
                        </div>

                        <div className="mb-3">
                            <label htmlFor="dateOfJoining" className="form-label">Date of Joining</label>
                            <input type="dateTime" className="form-control" id="dateOfJoining" name="dateOfJoining" value={employee.dateOfJoining} onChange={handleChange}  />
                        </div>
                        
                        <div className="mb-3">
                        <label htmlFor="role" className="form-label">Role</label>
                        <input type='text' className='form-control' id='role' name='role' value={employee.role} onChange={handleChange} />
